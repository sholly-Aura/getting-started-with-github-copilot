...
activities = {
    ...
    "Basketball Team": {
        ...
        "max_participants": 15,
        "participants": ["alex@mergington.edu", "amanda@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Recreational soccer practice and weekend scrimmages",
        "schedule": "Wednesdays and Saturdays, 3:30 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["dylan@mergington.edu", "nina@mergington.edu"]
    },
    "Drama Club": {
    ...
    "Art Studio": {
        ...
        "max_participants": 20,
        "participants": ["zoe@mergington.edu", "rafael@mergington.edu"]
    },
    "Math Club": {
        "description": "Problem solving, math competitions, and weekly puzzles",
        "schedule": "Wednesdays, 3:00 PM - 4:30 PM",
        "max_participants": 15,
        "participants": ["noah@mergington.edu", "hannah@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Prepare for regional science competitions with hands-on experiments",
